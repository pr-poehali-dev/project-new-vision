...
export function FaqSection() {
  const faqs = [
    {
      question: "Что такое SportMap?",
      answer:
        "SportMap — это платформа для поиска спортивных площадок вашего города. Интерактивная карта с фильтрами по типу спорта, рейтингами и отзывами пользователей, социальными функциями, AI-тренером и календарём событий.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "SportMap полностью адаптирован для мобильных браузеров. Мобильное приложение с синхронизацией фитнес-трекеров и push-уведомлениями о тренировках и событиях находится в разработке.",
    },
  ]
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 opacity-70">
                Всё, что нужно знать о SportMap — платформе для активного образа жизни.
              </p>
            </div>
          </div>
        </ScrollReveal>
