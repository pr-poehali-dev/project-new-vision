...
export function PricingSection() {
  const plans = [
    {
      name: "Бесплатно",
      description: "Для тех, кто только начинает активный образ жизни.",
      price: "0 ₽",
      duration: "навсегда",
      features: [
        "Карта площадок без ограничений",
    ...
    {
      name: "Про",
      description: "Для активных спортсменов и организаторов тренировок.",
      price: "299 ₽",
      duration: "в месяц",
      features: [
        "Всё из бесплатного тарифа",
        "Поиск партнёров для тренировок",
        "Создание клубов и групп",
        "Полный AI-тренер с планами",
        "Синхронизация с фитнес-трекерами",
        "Аналитика активности",
        "Участие в челленджах с призами",
      ],
      cta: "Выбрать Про",
      popular: true,
    },
    {
      name: "Клуб",
      description: "Для спортивных клубов, секций и организаций.",
      price: "1 990 ₽",
      duration: "в месяц",
      features: [
        "Всё из тарифа Про",
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 opacity-70">
                Начните бесплатно и переходите на Pro, когда захотите большего от своих тренировок.
              </p>
            </div>
          </div>
        </ScrollReveal>
